...
func TestLess(t *testing.T) {
	id1 := NewKademliaID("00000000000000000000FFFFFFFFFFFFFFFFFFFF")
	id2 := NewKademliaID("FFFFFFFFFFFFFFFFFFFF00000000000000000000")
...
func TestEquals(t *testing.T) {
	...
	id2 := NewKademliaID("FFFFFFFFFF0000000000FFFFFFFFFF0000000000")
	id3 := NewKademliaID("0000000000FFFFFFFFFF0000000000FFFFFFFFFF")
...
func TestCalcDistance(t *testing.T) {
	id1 := NewKademliaID("FFFFFFFFFF0000000000FFFFFFFFFF0000000000")
	id2 := NewKademliaID("0000000000FFFFFFFFFF0000000000FFFFFFFFFF")
...
func TestString(t *testing.T) {
	id := NewKademliaID("FFFFFFFFFF0000000000FFFFFFFFFF0000000000")
	expectedString := "ffffffffff0000000000ffffffffff0000000000"
